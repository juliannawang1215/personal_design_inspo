...
Background #e4f222, text #08090a, border-radius 9999px, padding 10px 18px, Inter 14px / weight 510, letter-spacing -0.011em. Sits as the sole filled chromatic element — every other button on the site is neutral.
...
Transparent background, border 1px #23252a, text #d0d6e0, border-radius 9999px, padding 8px 14px, Inter 13px / weight 400.
...
- Set card radius to 12px, button radius to 9999px (pills), input radius to 6px, badge radius to 4px
